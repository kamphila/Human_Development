...
#Region "Set Confic"
    ...
    End Property
#End Region
    Private Sub sSelectPosition_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim count As Integer = 1
        Dim position_name, station_name, branch_name As String
        Dim dt As DataTable
        dt = clsTB_Position.dsListPosition_Branch(Corp_id, branch_id).Tables(0)
        If Lang_Index = 1 Then
            position_name = "position_name01"
            station_name = "name_01"
            branch_name = "branch_name1"
        Else
            position_name = "position_name01"
            station_name = "name_02"
        ...
        With Me.position_level_lv
            ...
            If dt.Rows.Count > 0 Then
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    xitem.SubItems.Add(cNull(dt.Rows(i)(branch_name), "String"))
                    count = count + 1
                Next
        ...
        Try
            If position_level_lv.CheckedIndices.Count > 0 Then
                ...
                For Each N As Integer In Me.position_level_lv.CheckedIndices
                    ...
                    Me.Name_Position = Me.Name_Position & "," & Trim(Me.position_level_lv.CheckedItems(i).SubItems(1).Text)
                ...
                Me.Close()
            Else
                MessageBox.Show("กรุณาระบุตำแหน่ง", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
