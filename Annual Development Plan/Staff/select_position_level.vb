Public Class select_position_level
    ...
    Public Positionlevel_id, Name_Positionlevel As String
...
#Region "Set Confic"
    ...
    End Property
#End Region
    Private Sub sselect_position_level_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim count As Integer = 1
        Dim position_level_name As String
        Dim dt As DataTable
        dt = clsTB_Position.dsListPosition_level(Corp_id).Tables(0)
        If Lang_Index = 1 Then
            position_level_name = "name_01"
        Else
            position_level_name = "name_02"
        End If
        ...
        With Me.position_level_lv
            ...
            If dt.Rows.Count > 0 Then
                For i As Integer = 0 To dt.Rows.Count - 1
                    ...
                    xitem.SubItems.Add(cNull(dt.Rows(i)(position_level_name), "String"))
        ...
        Try
            If position_level_lv.CheckedIndices.Count > 0 Then
                ...
                For Each N As Integer In Me.position_level_lv.CheckedIndices
                    ...
                    Me.Name_Positionlevel = Me.Name_Positionlevel & "," & Trim(Me.position_level_lv.CheckedItems(i).SubItems(1).Text)
                    Positionlevel_id = Me.Positionlevel_id & "," & Trim(Me.position_level_lv.Items(N).Tag) & ""
                    i = i + 1
                Next
                Me.Flag_ActionOK = True
                Me.Close()
            Else
                MessageBox.Show("กรุณาระบุระดับตำแหน่ง", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Exit Sub
            End If
