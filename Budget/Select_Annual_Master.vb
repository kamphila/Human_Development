Public Class Select_Annual_Master
    Public Get_Course_Master_Id As String = String.Empty
    ...
    Private Sub Select_Annual_Master_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub binddata()
        ...
        If String.IsNullOrEmpty(Get_Course_Master_Id) = False Then
            Annual_Master.course_master = Get_Course_Master_Id
        End If
