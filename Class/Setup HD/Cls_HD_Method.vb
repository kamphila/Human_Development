...
#Region "Function"
    ...
    Function getById(id As String) As Boolean
        ...
        Dim dt As DataTable
        dt = Retreive()
        var_corp_id = dt.Rows(0).Item("hdm_corp_id").ToString()
        var_id = dt.Rows(0).Item("hdm_id").ToString()
        var_code = dt.Rows(0).Item("hdm_code").ToString()
        var_name = dt.Rows(0).Item("hdm_name").ToString()
        var_name2 = dt.Rows(0).Item("hdm_name2").ToString()
        var_desc = dt.Rows(0).Item("hdm_desc").ToString()
        Return True
    End Function
    ...
    Function CheckDupCode() As Boolean
        Try
            ...
            strcommand = "select 1 from hd_method "
            If var_id.Length > 0 Then
                strwc = " and hdm_id <> '" & var_id.ToString() & "'"
            End If
            strcommand = strcommand & vbCrLf & " where hdm_corp_id = ? and hdm_code = ? " + strwc
    ...
    Function Retreive() As DataTable
        Try
            ...
            End If
            strcommand = "select * "
            strcommand = strcommand & vbCrLf & "from hd_method where hdm_corp_id = '" & GBCorp & "' " & strwc
            strcommand = strcommand & vbCrLf & "order by hdm_code "
    ...
    Function Add() As Boolean
        ...
        Try
            SqlDB.BeginTrans()
            strcommand = "insert into hd_method(hdm_corp_id,hdm_id"
            strcommand = strcommand & vbCrLf & ",hdm_code,hdm_name,hdm_name2,hdm_desc,hdm_create_by,hdm_create_date)"
    ...
    Function Update() As Boolean
        ...
        Try
            SqlDB.BeginTrans()
            strcommand = "update hd_method"
            strcommand = strcommand & vbCrLf & "set hdm_code = ?"
            strcommand = strcommand & vbCrLf & ",hdm_name = ?"
            strcommand = strcommand & vbCrLf & ",hdm_name2 = ?"
            strcommand = strcommand & vbCrLf & ",hdm_Desc = ?"
            strcommand = strcommand & vbCrLf & ",hdm_edit_by = ?"
            strcommand = strcommand & vbCrLf & ",hdm_edit_date= ?"
            strcommand = strcommand & vbCrLf & "where hdm_id = ? "
            cmd = SqlDB.CreateCommand(strcommand)
    ...
    Function Delete() As Boolean
        ...
        Try
            SqlDB.BeginTrans()
            strcommand = "delete from hd_method "
            strcommand = strcommand & vbCrLf & "where hdm_id = ? "
            cmd = SqlDB.CreateCommand(strcommand)
