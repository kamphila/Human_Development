...
#Region "Function"
    ...
    Function getById(id As String) As Boolean
        ...
        Dim dt As DataTable
        dt = Retreive()
        var_corp_id = dt.Rows(0).Item("hdc_corp_id").ToString()
        var_id = dt.Rows(0).Item("hdc_id").ToString()
        var_code = dt.Rows(0).Item("hdc_code").ToString()
        var_name = dt.Rows(0).Item("hdc_name").ToString()
        var_name2 = dt.Rows(0).Item("hdc_name2").ToString()
        var_desc = dt.Rows(0).Item("hdc_desc").ToString()
        Return True
    End Function
    ...
    Function CheckDupCode() As Boolean
        Try
            ...
            strcommand = "select 1 from hd_cost "
            If var_id.Length > 0 Then
                strwc = " and hdc_id <> '" & var_id.ToString() & "'"
            End If

            strcommand = strcommand & vbCrLf & " where hdc_corp_id = ? and hdc_code = ? " + strwc
    ...
    Function Retreive() As DataTable
        Try
            ...
            End If
            strcommand = "select * "
            strcommand = strcommand & vbCrLf & "from hd_cost where hdc_corp_id = '" & GBCorp & "' " & strwc
            strcommand = strcommand & vbCrLf & "order by hdc_code "
    ...
    Function Add() As Boolean
        ...
        Try
            SqlDB.BeginTrans()
            strcommand = "insert into hd_cost(hdc_corp_id,hdc_id"
            strcommand = strcommand & vbCrLf & ",hdc_code,hdc_name,hdc_name2,hdc_desc,hdc_create_by,hdc_create_date)"
    ...
    Function Update() As Boolean
        ...
        Try
            SqlDB.BeginTrans()
            strcommand = "update hd_cost"
            strcommand = strcommand & vbCrLf & "set hdc_code = ?"
            strcommand = strcommand & vbCrLf & ",hdc_name = ?"
            strcommand = strcommand & vbCrLf & ",hdc_name2 = ?"
            strcommand = strcommand & vbCrLf & ",hdc_Desc = ?"
            strcommand = strcommand & vbCrLf & ",hdc_edit_by = ?"
            strcommand = strcommand & vbCrLf & ",hdc_edit_date= ?"
            strcommand = strcommand & vbCrLf & "where hdc_id = ? "
            cmd = SqlDB.CreateCommand(strcommand)
    ...
    Function Delete() As Boolean
        ...
        Try
            SqlDB.BeginTrans()
            strcommand = "delete from hd_cost "
            strcommand = strcommand & vbCrLf & "where hdc_id = ? "
            cmd = SqlDB.CreateCommand(strcommand)
