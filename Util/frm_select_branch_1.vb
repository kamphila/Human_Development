...
Public Class frm_select_branch_1
    ...
    Public Property Config() As SortedList
        ...
        End Set
    End Property
    Private Sub frm_select_branch_1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub CmdPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CmdPrint.Click
        Try
            ...
            BegDate = DateTime.Parse(Me.tbx_date_from.Text, New CultureInfo(gb_Culture))
            EndDate = DateTime.Parse(Me.tbx_date_to.Text, New CultureInfo(gb_Culture))
